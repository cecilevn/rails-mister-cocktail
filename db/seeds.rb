# My first seed below used an API, then I used The Wagon seeding file
# Don't forget to add the destroy_all before seeding
# require 'json'
# require 'open-uri'
...
# ingredient = JSON.parse(list_serialized)
# ingredient["drinks"].sample(3).each do |ingredient|
